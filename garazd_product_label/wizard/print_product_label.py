...
class PrintProductLabel(models.TransientModel):
    ...
    template = fields.Selection(
        selection=[('garazd_product_label.report_product_label_A5_57x35', 'Label 57x35mm (A5: 21 pcs on sheet, 3x7)'),
        ('garazd_product_label.report_product_label_A4_40x35','Label 40x35mm(A4)')],
        string='Label template',
        default='garazd_product_label.report_product_label_A5_57x35',
    )
